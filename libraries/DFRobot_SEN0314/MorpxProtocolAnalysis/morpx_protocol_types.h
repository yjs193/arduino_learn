...
typedef SimpleListMu<device_node_t> device_list_t;
struct port_tt {
  port_addr_t port_addr;
  device_list_t device_list;
};
typedef SimpleNode<port_tt> port_node_t;
typedef SimpleListMu<port_node_t> port_list_t;
