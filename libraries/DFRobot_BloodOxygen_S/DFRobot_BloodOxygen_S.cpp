...
int DFRobot_BloodOxygen_S::getSPO2(void)
{
  this->getHeartbeatSPO2();
  if(_sHeartbeatSPO2.SPO2 == 0)
  {
    return _sHeartbeatSPO2.SPO2 = -1;
  }else{
    return _sHeartbeatSPO2.SPO2;
  }
}

int DFRobot_BloodOxygen_S::getHeartbeat(void)
{
  this->getHeartbeatSPO2();
  if (_sHeartbeatSPO2.Heartbeat == 0)
  {
    return _sHeartbeatSPO2.Heartbeat = -1;
  }else{
    return _sHeartbeatSPO2.Heartbeat;
  }
}
...
DFRobot_BloodOxygen_S_HardWareUart::DFRobot_BloodOxygen_S_HardWareUart(HardwareSerial *phardUart, int rx, int tx)
:_modbus(phardUart),_pharduart(phardUart),_baudRate(9600)
{
    phardUart->begin(9600, rx, tx);
}
#else
