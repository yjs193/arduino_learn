...
uint8_t DFRobot_VEML7700::setGain(als_gain_t gain)
{
...
uint8_t DFRobot_VEML7700::getGain(als_gain_t& gain)
{
  gain = als_gain_t(
...
uint8_t DFRobot_VEML7700::setIntegrationTime(als_itime_t itime)
{
...
uint8_t DFRobot_VEML7700::getIntegrationTime(als_itime_t& itime)
{
  itime = als_itime_t(
...
uint8_t DFRobot_VEML7700::setPersistence(als_persist_t persist)
{
...
uint8_t DFRobot_VEML7700::setPowerSavingMode(als_powmode_t powmode)
{
...
float DFRobot_VEML7700::getALSLux()
{
  uint32_t raw_counts;
...
uint8_t DFRobot_VEML7700::sampleDelay()
{
  als_itime_t itime;
  getIntegrationTime(itime);
