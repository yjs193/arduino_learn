#ifndef DFROBOT_PLAYERMINI_H
#define DFROBOT_PLAYERMINI_H
#include "Arduino.h"
...
#if defined(NRF5)
  bool       begin(int rx, int tx, bool isACK = false);
#elif defined(NRF52833)
  bool       begin(int rx, int tx, bool isACK = false);
#else
  bool       begin(HardwareSerial *serial, int rx, int tx, bool isACK = false);
#endif
  bool       begin(SoftwareSerial *serial, bool isACK = false);
